...
import Dashboard from "Frontend/views/@index";
import ChatView from "Frontend/views/chat/ChatView";
import StreamingChatView from "Frontend/views/chat/StreamingChatView";
...
export const { router, routes } = new RouterConfigurationBuilder()
    ...
    //         handle: { title: 'Home' },
    //         children: [
    //             { path: '/chat', element: <ChatView />, handle: { title: 'AI Chat' } }
    //         ],
    //       }
    //     ]
    // )
    ...
    .withReactRoutes(
      [
          { path: '/chat', element: <ChatView />, handle: { title: 'AI Chat' } },
          { path: '/streaming-chat', element: <StreamingChatView />, handle: { title: 'AI Streaming Chat' } }
      ]
    )
